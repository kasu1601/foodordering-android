...
import com.example.comp2008_assignment1.DBSchema.RestaurantTable;
import com.example.comp2008_assignment1.DBSchema.FoodItemTable;
import com.example.comp2008_assignment1.DBSchema.UserTable;
import com.example.comp2008_assignment1.DBSchema.OrderTable;
...
public class DBModel
{
        ...
        /* add all food items into the database */
        public void updateFoodItemTable()
        {
            addFoodItem(db,"Java Lounge", R.drawable.javalounge_berry_cake, "Berry Bite", "Made with fresh blueberries and raspberries", 2.99);
            addFoodItem(db,"Java Lounge", R.drawable.javalounge_berry_cheesecake, "Berry Delight", "Delightful flavour blast of raspberries!", 4.29);
            addFoodItem(db,"Java Lounge", R.drawable.javalounge_crepe_cake, "Vanilla crepe cake", "Handmade and Authentic",2.99);
            addFoodItem(db,"Java Lounge", R.drawable.javalounge_cake_pops, "Sugary Pops!", "Cake crumbs mixed with chocolate icing and white chocolate", 2.98);
            addFoodItem(db,"Java Lounge", R.drawable.javalounge_fruit_tart, "Fruity Fun", "Filled with raspberries, blue berries and strawberries",3.59);
            addFoodItem(db,"Java Lounge", R.drawable.javalounge_choco_cookies, "Chocolate cookies", "Fresh, crunchy cookies filled with chocolate chips", 5.00);
            addFoodItem(db,"Java Lounge", R.drawable.javalounge_churros, "Churros", "Served with a side of gooey chocolate sauce", 0.99);
            addFoodItem(db,"Java Lounge", R.drawable.javalounge_berry_tart, "Blueberry Tart", "Mouthfuls of zesty blue berry goodness", 1.98);
            addFoodItem(db,"Java Lounge", R.drawable.javalounge_fruit_salad, "Fruit salad bowl", "Freshly cut pineapples, bananas, berries and kiwi",2.88);
            addFoodItem(db,"Java Lounge", R.drawable.javalounge_iced_tea, "Strawberry Iced Tea", "Refreshing chilly tea to sip on", 1.79);
            addFoodItem(db,"Java Lounge", R.drawable.javalounge_lemon_juice, "Lemon juice", "500ml", 1.29);
            addFoodItem(db,"Java Lounge", R.drawable.javalounge_macaroons, "Macaroons", "Set of four macaroons", 6.59);
            addFoodItem(db,"Java Lounge", R.drawable.javalounge_strawberry_milkshake, "Strawberry Milkshake", "1000ml", 3.95);
            addFoodItem(db,"Java Lounge", R.drawable.javalounge_oj, "Fresh OJ", "300ml", 2.99);
            addFoodItem(db,"Java Lounge", R.drawable.javalounge_red_cupcake, "Red-velvet cupcake", "Topped with red cream cheese icing", 1.59);

            addFoodItem(db,"Cafe by Raffles", R.drawable.raffles_strawberry_iced_tea, "Strawberry Shake", "500ml", 1.99);
            addFoodItem(db,"Cafe by Raffles", R.drawable.raffles_cinnamon_rolls, "Cinnamon rolls", "2 cinnamon rolls served with a side of cream cheese icing", 2.09);
            addFoodItem(db,"Cafe by Raffles", R.drawable.raffles_vanilla_cake_slice, "Vanilla cake", "Vanilla cake topped with buttercream", 1.99);
            addFoodItem(db,"Cafe by Raffles", R.drawable.raffles_coffee_mousse, "Coffee mousse", "Cappuccino flavoured mousse", 1.55);
            addFoodItem(db,"Cafe by Raffles", R.drawable.raffles_strawberry_mousse, "Strawberry mousse", "Topped with freshly cut strawberries", 1.55);
            addFoodItem(db,"Cafe by Raffles", R.drawable.raffles_choco_overload_shake, "Choco-Overload!", "Blast of white chocolate, milk chocolate and yummy marshmallows", 2.19);
            addFoodItem(db,"Cafe by Raffles", R.drawable.raffles_fruit_salad, "Fruit salad bowl", "No cashews included",  2.88);
            addFoodItem(db,"Cafe by Raffles", R.drawable.raffles_cheese_cake, "Lime cheesecake", "Perfectly tangy, Perfectly sweet",  2.99);
            addFoodItem(db,"Cafe by Raffles", R.drawable.raffles_macchiato, "Caramel Macchiato", "500ml", 1.99);
            addFoodItem(db,"Cafe by Raffles", R.drawable.raffles_choco_milkshake, "Chocolate Milkshake", "800ml",  2.95);
            addFoodItem(db,"Cafe by Raffles", R.drawable.raffles_nutella_waffle, "Nutty Waffles", "Crunchy waffles downed in Nutella", 3.99);
            addFoodItem(db,"Cafe by Raffles", R.drawable.raffles_pink_cake, "Neon Pink Blast", "Tangy cake with a lemon base", 3.99);
            addFoodItem(db,"Cafe by Raffles", R.drawable.raffles_waffles, "Creamy Waffle Party", "Served with a hearty side of whipped cream and berries",  3.49);
            addFoodItem(db,"Cafe by Raffles", R.drawable.raffles_donut, "Donuts Gonuts", "Soft donuts glazed with yummy chocolate sauce", 2.88);
